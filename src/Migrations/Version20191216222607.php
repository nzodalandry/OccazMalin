 ...
 */
final class Version20191216222607 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ads (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', created_by_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', title VARCHAR(90) NOT NULL, slug VARCHAR(90) NOT NULL, price NUMERIC(10, 2) NOT NULL, description LONGTEXT DEFAULT NULL, language CHAR(2) NOT NULL, state enum(\'new\', \'used\', \'broken\'), date_publish DATETIME NOT NULL, date_expire DATETIME NOT NULL, INDEX IDX_7EC9F620B03A8386 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE offers (id INT AUTO_INCREMENT NOT NULL, user_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', ad_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', price NUMERIC(10, 2) NOT NULL, message LONGTEXT DEFAULT NULL, offer_dare DATETIME NOT NULL, INDEX IDX_DA460427A76ED395 (user_id), INDEX IDX_DA4604274F34D596 (ad_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
